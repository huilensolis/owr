...
export function Header({ headerItems }: input) {
  return (
    <header className="w-screen px-5 h-max flex justify-between items-center py-3 gap-5 border-b-2 border-cm-light-gray dark:border-cm-gray fixed top-0 left-0">
